...
class TestBuildPrompt:
    ...
    def test_prompt_instructs_no_title_heading(self):
        prompt = _build_prompt("transcript", max_chars=500, channel_name="AnyChannel", bullet_limit=5)
        assert "title is provided separately" in prompt.lower()
